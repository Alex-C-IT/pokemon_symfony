...
final class Version20240130194933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon_dresseur (pokemon_id INT NOT NULL, dresseur_id INT NOT NULL, INDEX IDX_F08EE6682FE71C3E (pokemon_id), INDEX IDX_F08EE668A1A01CBE (dresseur_id), PRIMARY KEY(pokemon_id, dresseur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE token_validation (id INT AUTO_INCREMENT NOT NULL, token VARCHAR(255) NOT NULL, date_heure_creation DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_heure_expiration DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', user_id INT NOT NULL, UNIQUE INDEX UNIQ_FE604AD05F37A13B (token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom_utilisateur VARCHAR(25) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(150) NOT NULL, roles JSON NOT NULL, date_inscription DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status INT NOT NULL, is_subscribed_newsletter TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649D37CC8AC (nom_utilisateur), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pokemon_dresseur ADD CONSTRAINT FK_F08EE6682FE71C3E FOREIGN KEY (pokemon_id) REFERENCES pokemon (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE pokemon_dresseur ADD CONSTRAINT FK_F08EE668A1A01CBE FOREIGN KEY (dresseur_id) REFERENCES dresseur (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon_dresseur DROP FOREIGN KEY FK_F08EE6682FE71C3E');
        $this->addSql('ALTER TABLE pokemon_dresseur DROP FOREIGN KEY FK_F08EE668A1A01CBE');
