...
class DresseurFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $dresseur = new Dresseur('1', 'Sacha', 170, false, 'Je veux devenir le meilleur dresseur !');
        ...
        $dresseur = new Dresseur('2', 'Regis', 180, false, 'Sacha, mon rival éternel !');
        ...
        $dresseur = new Dresseur('3', 'Flora', 160, true, 'Je suis la championne !');
