...
class AttaqueFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $attaque = new Attaque('ATQ01', 'Pistolet à O', 'De l\'eau est projetée avec force sur la cible.', 40, 100, 35, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Eau'));
        ...
        $attaque = new Attaque('ATQ02', 'Hydrocanon', 'Un puissant jet d\'eau est dirigé sur la cible.', 110, 80, 5, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Eau'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ03', 'Lance-Flammes', 'Un jet de feu brûlant est projeté sur la cible.', 90, 100, 15, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Feu'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ04', 'Déflagration', 'Un puissant jet de feu qui peut brûler la cible.', 110, 85, 5, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Feu'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ05', 'Tranch\'Herbe', 'Lames d\'air tranchantes comme des lames de rasoir.', 55, 95, 25, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Plante'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ06', 'Tempête Verte', 'Une tempête de feuilles taillantes balaie la cible.', 90, 100, 15, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Plante'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ07', 'Tonnerre', 'Une violente décharge électrique s\'abat sur la cible.', 90, 100, 15, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Foudre'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ08', 'Fatal-Foudre', 'Une violente décharge électrique s\'abat sur la cible. Peut paralyser la cible.', 110, 70, 10, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Foudre'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ09', 'Rapace', 'Une charge brutale qui blesse aussi l\'utilisateur.', 120, 100, 15, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Vol'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ10', 'Vent Violent', 'Une bourrasque violente qui s\'abat sur la cible.', 110, 70, 10, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Vol'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ11', 'Choc Mental', 'Une puissante attaque psychique qui peut aussi baisser la Défense Spéciale de la cible.', 50, 100, 25, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Psy'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ12', 'Psyko', 'Une puissante attaque psychique qui peut aussi baisser la Défense Spéciale de la cible.', 90, 100, 10, false, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Psy'));
        $manager->persist($attaque);
        ...
        $attaque = new Attaque('ATQ13', 'Surf', 'Une vague déferlante s\'abat sur tout ce qui entoure l\'utilisateur. Peut aussi être utilisée pour traverser l\'eau.', 90, 100, 15, true, $this->getReference(TypeFixtures::TYPE_REFERENCE.'_Eau'));
        $manager->persist($attaque);
